...
class CartBuilderTest extends TestCase
{
    ...
    {
        $cart = new Cart('3db5f857-e5a3-4c8d-a262-37da156c0001');
        $cartProduct1 = new CartProducts($cart, new Product('16e0226c-0ed8-434a-9342-429aefeb98f0', 'Product 1', 1990));
        $cartProduct2 = new CartProducts($cart, new Product('5884ad4c-9ac2-40a5-ba11-1a96156c5889', 'Product 2', 3690));
